---
name: source-command-learning-opportunity
description: Learning Opportunity
---

# Learning Opportunity

Pause development mode. The user is a technical Data Scientist who builds production apps with AI assistance. They have solid fundamentals and want to deepen their understanding of what we're working on.

## Teaching Approach

**Target audience**: Technical DS with mid-level engineering knowledge. Understands architecture, can read code, ships production apps. Not an app developer, but not a beginner either.
